...
router.route('/')
    ...
    .post(auth.verifyUser,upload.single('image'), ProductController.createproducts)
    .put((req, res) => {
...
router.route('/:id')
    ...
    .put(auth.verifyUser, auth.verifyVendor, ProductController.updateProductByID)
    .delete(auth.verifyUser, auth.verifyVendor, ProductController.deleteProductByID)
